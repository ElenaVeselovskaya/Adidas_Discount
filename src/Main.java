public class Main {
    public static void main(String[] args) {
        ...
        int limitOfTwentuPercentDiscountInRub = 30_000;

        int totalAmountOfPurchasesInRub = 30_000;
        ...
        if (totalAmountOfPurchasesInRub >= limitOfTwentuPercentDiscountInRub) {
            ...
            if (totalAmountOfPurchasesInRub >= limitOfTenPercentDiscountInRub) {
                ...
                if (totalAmountOfPurchasesInRub >= limitOfFivePercentDiscountInRub) {
